...
import { Flex, Box, Center, Text, FormControl, FormLabel, Input } from "@chakra-ui/react";
    ...
    <Template variant="secondary">
      ...
      >
        ...
        <Box display={"flex"} flexDir={{ base: "column", md: "column", lg: "row" }}>
          ...
          <DefaultButton variant="home2" label="Administrar meios de pagamento ->" h={"67px"} borderRadius={"10px"} />
          <Box
            borderRadius="25px"
